//// The zinc theme preset. Neutral greys with a near-black primary: quiet, and at home anywhere.
////
//// ```gleam
//// import howdy/ui/themes/zinc
////
//// page.new("Orders")
//// |> page.themes(zinc.themes())
//// ```
////
...
//// with `gleam run -m howdy/ui add zinc` to adjust it. Every text colour
